...
<html lang="en">
  ...
  <body>
      ...
      <div id="home-slider" class="owl-carousel">
        <div>
          <div class="sliding-card-with-bottom-image text-center padding-top-90">
            <h2 class="cta-heading text-white"><span class="markFont">เกมยอดฮิตที่ไม่มีใครไม่รู้จัก “RoV”</span></h2>
            <p class="text-white slider-para"><span class="markFont">‘เกมกีฬา’ ที่กำลังได้รับการยอมรับ และความนิยมอย่างสูง</span></p>
        ...
        <div>
          <div class="container">
            <div class="row">
              <div class="image-right-slide-bg clearfix" style="background-image:url(images/cute_blur_nobg450.png)">
                <div class="col-md-12">
    ...
    <section id="feature" class="padding-top-bottom-120 bg-image-fit-50" style="">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
...
มาร่วมก๊วนตั้งแก๊ง  เพื่อเฟ้นหาสุดยอดทีม ที่สามารถผ่านเข้ารอบสุดท้าย ที่จะทำให้หัวใจ <i class="ion-ios-pulse-strong"></i> เต้นรัวๆ กับเหล่าบันดาสาวสวย Cosplay และ ครูอาย Net Idol ที่ใครๆก็อยากมาเป็นลูกศิษย์ <i class="ion-ios-color-wand"></i></p>
              </div>
            </div>
            <div class="feature-wiget">
              <div class="icon-wraper">
              ...
              <div class="content">
                <h4 class="bottom-line"><span class="markFont">รางวัลสำหรับทีมที่เข้ามาถึงรอบสุดท้าย</span></h4>
                <p> เงินรางวัลสำหรับทีมผู้ชนะ อันดับ 1-3  และของรางวัลติดไม้ติดมือกลับบ้าน จากทาง Garana Thailand.</p>
              </div>
            </div>
            <div class="feature-wiget">
              <div class="icon-wraper">
              ...
              <div class="content">
                ...
                <p>&nbsp;&nbsp;&nbsp;&nbsp;ก๊วนไหน แก็คไหน ไม่ผ่านรอบคัดเลือก  ก็มีสิทธิ์ได้รางวัลเป็น Coin ในเกม จาก Garena Thailand ผู้เข้าร่วมการแข่งขัน ทุกท่าน หากเข้ามาร่วมชมสดๆ ในวันงาน ก็อาจเป็นผู้โชคดีได้เป็นเศรษฐีหรือไอเทมดีๆในเกม</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-8">
            <div class="row">
              <div class="col-md-6">
                <div class="heading-wraper text-center margin-bottom-80">
					<h4><span class="markFont">กติกาการแข่งขัน</span></h4>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
				  <h5 class="service-title"><span class="markFont">รอบคัดเลือก</span></h5>
                <p class="services-content margin-bottom-25">&nbsp;&nbsp;&nbsp;&nbsp;แข่งกันแบบ น๊อคเอ๊า มีสมาชิกในทีมได้ 7 คน แข่งจริงในเกม 5 สำรอง 2 คน โดยจะมีการแข่งขันทุกเสาร์-อาทิตย์  ซึ่งทั้ง 2 ทีมจะมีหัวหน้าทีมที่คอยนัดหมาย สมาชิกในทีมให้เข้ามาสู่การแข่งขันในเกมตามเวลาที่กำหนด </p>
              </div>
              <div class="col-md-6 col-sm-6">
                <h5 class="service-title"><span class="markFont">รอบสุดท้าย</span></h5>
                <p class="services-content margin-bottom-25"><span class="markFont">&nbsp;&nbsp;&nbsp;&nbsp;ทีมที่ผ่านเข้ามารอบสุดท้ายจะมีทั้งหมด 4 ทีม แข่งขันแบบ Mini Leage ประกบคู่ แข่งกัน 3 ครั้ง จับทีมที่ชนะ 2 ทีมเข้าสู่การหาทีมผู้ชนะเลิศในการแข่งรอบ Final โดยจัดการแข่งขันที่คณะวิศวกรรมศาสตร์ มหาวิทยาลัยนเรศวร
วันที่ 17 สิงหาคม 2561</span></p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <h5 class="service-title"><span class="markFont">การแข่งขันในรอบคัดเลือก</span></h5>
                <p class="services-content margin-bottom-25">&nbsp;&nbsp;&nbsp;&nbsp;ภายหลังจากตารางแข่งขันถูกกำหนดอย่างเป็นทางการ จะมีช่วงเวลา ให้ทั้ง 2 ทีม นัดหมายกันแข่งขัน ภายในเวลาที่กำหนด  หากทีมผู้เข้าแข่งทั้ง 2 ทีม ส่งผลการแข่งขัน โดยการ Capture ผลการแข่งท้ายเกมส์ แล้วดำเนินการส่งผลผ่านทางโพส Official Page Facebook ไม่ทัน หรือ เวลาสิ้นสุดการแข่งขัน(จากภาพในเกมที่ส่งมา) เกินกว่าเวลาที่ถูกกำหนดไว้ จะถือว่า ผิดกติกาการแข่งขัน โมฆะและตกรอบทั้ง 2 ทีม</p>
              </div>
              <div class="col-md-6 col-sm-6">
                <h5 class="service-title"></h5>
                <p class="services-content margin-bottom-25"><a href="#" class="btn btn-orange border-none btn-rounded-corner btn-navbar">อ่านกติกาทั้งหมด<span class="icon-on-button"><i class="ion-android-bookmark"></i></span></a></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div>
        <span style="display: inline-block; width: 32%;font-size: 60px;"><span>$</span><span class="counter">43,753</span></span>
        <span class="counter" style="display: inline-block; width: 32%;font-size: 60px;">1,734,195.10</span>
        <span class="counter" style="display: inline-block; width: 32%;font-size: 60px;">849203</span>
    </div>
          </div>
        </div>
      </div>
